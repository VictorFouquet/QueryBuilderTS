import { AggregateOperators, BooleanOperators, LiteralLikeOperators, LiteralOperators, NumericalOperators, NumericalRangeOperators } from "./query.types";
...
export const LIKE_OPS:      LiteralLikeOperators[]    = ['like'];
